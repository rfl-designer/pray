...
<div class="flex items-center justify-end p-4 w-full md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse relative">
    <button type="button" wire:click="setUserMenu" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
